...
# Set dataset paths for MS-SNSD (adjust these to your environment)
DATA_ROOT = "/home/afilip/datasets/MS-SNSD"
...
# %%
# -----------------------------------------------------------------------------------
# 4. ONNX EXPORT TEST (unchanged from previous code)
# -----------------------------------------------------------------------------------
...
# %%
from losses import CombinedLoss, time_domain_l1
...
for epoch in range(NUM_EPOCHS):
    ...
    # (Optional) Log example audio and spectrogram images.
    # Here we use a sample from the validation set.
    with torch.no_grad():
